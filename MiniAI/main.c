...
int main(int argc, const char * argv[]) {
    ...
    randomLocations my_randoms, *my_randoms_help;

    my_randoms_help = &my_randoms;
//    system("clear");
    ...
    my_randoms.result = perceptron_motor_predict(my_perceptron.params, my_perceptron.batch_size, my_perceptron.n_params, my_perceptron.data, browser.y, &my_randoms_help);
    ...
    perceptron_view_getWeights(&my_perceptron);
    perceptron_view_printResult(my_randoms.result, my_perceptron.batch_size);
    error = perceptron_motor_fit(&my_perceptron, browser.y, &my_randoms);
